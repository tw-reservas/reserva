                        ...
                        <div class="bs-stepper">
                            <div class="bs-stepper-header col-md-6 m-auto" role="tablist">
                                ...
                                <div class="step" data-target="#calendarios-part">
                                    <button type="button" class="step-trigger" role="tab" aria-controls="calendarios-part"
                                        id="calendarios-part-trigger">
                                ...
                                <div class="step" data-target="#grupos-part">
                                    <button type="button" class="step-trigger" role="tab" aria-controls="grupos-part"
                                        id="grupos-part-trigger">
                ...
                var calendar = new FullCalendar.Calendar(calendarEl, {
                    ...
                    dateClick: function(info) {
                        ...
                        if (now.isSameOrBefore(dateClick, 'day') &&
                            ...
                            $('#grupos tbody').html("");
                            var ruta = "reserva/" + {{ $orden->codigo }} + "/date/" + info
                                .dateStr;
