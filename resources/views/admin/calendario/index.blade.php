            ...
            <div class="col-md-10 m-auto">
                <div class="card">
                                ...
                                @endif
                                    <td>
                                        <form action="{{route ('calendario.destroy',$calendario->id)}}" method="POST">
                                            ...
                                            @else
                                            <a href="/admin/detalle-calendario/ver/{{$calendario->id}}" class="btn btn-info btn-sm">Ver Detalles</a>
                                            @endif
                                        </form>
                                    </td>
                                </tr>
                    ...
                    <div class="card-footer clearfix">
                        <h6><span class="badge bg-success">Activo</span> : El calendario sera utilizado para la reparticion de calendarios</h6>
