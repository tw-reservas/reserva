            ...
            <div class="col-md-8">
                <div class="card2 card-outline">
                    ...
                    <div class="card-body2 pad table-responsive">
                        <div class="col-md-6">
                            <form action="{{ route('feriados.store') }}" method="POST" id="form-create-feriado">
                                @csrf
                                <div class="mb-3">
    ...
    <script>
        window.onload = function() {
            document.getElementById('guardar').onclick = function() {
                ...
                toastr.success('CAMPOS CORRECTOS, !!GUARDANDO Feriados!!');
                document.getElementById('form-create-feriado').submit();
                return false;
            }
