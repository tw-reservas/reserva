                   ...
                   <div class="col-md-6">
                    <form action="{{route ('user.store')}}" method="POST" id = "form-grupo">
                        ...
                        <div class="mb-3">
                            ...
                            <input id="matricula" placeholder="Ingrese su matricula" name="matricula" autocomplete="off" type="text" class="form-control @error('matricula')
                                is-invalid
                            @enderror" tabindex="2">
                            @error('matricula')
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input id="password" placeholder="Ingrese su contraseña" name="password" autocomplete="off" type="password" class="form-control @error('password')
                                        is-invalid
                                    @enderror" tabindex="2">
                                    @error('password')
                                    <span class="invalid-feedback" role="alert">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input id="password1" placeholder="repita su contraseña" name="password1" autocomplete="off" type="password" class="form-control @error('password1')
                                        is-invalid
                                    @enderror" tabindex="1">
                                    @error('password1')
                                    <span class="invalid-feedback" role="alert">
                        ...
                        <div class="mb-3">
                            ...
                            <input id="paterno" placeholder="Apellido paterno" name="paterno" autocomplete="off" type="text" class="form-control @error('paterno')
                                is-invalid
                            @enderror" tabindex="2">
                            @error('paterno')
                            <span class="invalid-feedback" role="alert">
                        ...
                        <div class="mb-3">
                            ...
                            <input id="materno" placeholder="Apellido materno" name="materno" autocomplete="off" type="text" class="form-control @error('materno')
                                is-invalid
                            @enderror" tabindex="2">
                            @error('materno')
                            <span class="invalid-feedback" role="alert">
                        ...
                        <div class="mb-3">
                            ...
                            <input id="telefono" placeholder="telefono" name="telefono" autocomplete="off" type="text" class="form-control @error('telefono')
                                is-invalid
                            @enderror" tabindex="2">
                            @error('telefono')
                            <span class="invalid-feedback" role="alert">
                        ...
                        <div class="mb-3">
                            ...
                            <input id="email" placeholder="email" name="email" autocomplete="off" type="text" class="form-control @error('email')
                                is-invalid
                            @enderror" tabindex="2">
                            @error('email')
                            <span class="invalid-feedback" role="alert">
                        ...
                        <a href="{{route('user.index')}}" class="btn btn-secondary btn-sm" tabindex="5">Cancelar</a>
