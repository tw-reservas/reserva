                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input id="horaInicio" name="horaInicio" type="time" value="05:00"
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3 ">
                                            ...
                                            <input id="horaFin" name="horaFin" type="time" value="06:00"
                                                class="form-control @error('horaFin') is-invalid @enderror" tabindex="2">
                                            @error('horaFin')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
