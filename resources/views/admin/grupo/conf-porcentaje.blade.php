                ...
                <div class="card-body pad table-responsive">
                   <div class="col-md-6">
                       ...
                       <div class="text-center">
                            ...
                            <a href="{{route('grupo.index')}}" class="btn btn-secondary btn-sm" tabindex="5">Ir a Activar</a>
                        </div>
                       @else
                       <form id ="form-porc" action="{{route ('grupo.conf-porcentaje')}}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input id="{{$grupo->id}}" placeholder="Ingrese un número" name="{{$grupo->id}}" value="" type="text" class="form-control @error('nombre')
                                is-invalid
                            @enderror" >
                            @error('nombre')
                        ...
                        @endforeach
                        <a href="{{route('grupo.index')}}" class="btn btn-info btn-sm" tabindex="5">Ir a Activar</a>
