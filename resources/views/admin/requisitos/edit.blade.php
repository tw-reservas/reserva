        ...
        <div class="col-md-12">
            <div class="card card-success card-outline">
                ...
                <div class="card-body pad table-responsive">
                   <div class="col-md-6">
                    <form action="{{route ('requisitos.update',$requisitos->id)}}" method="POST" id = "form-grupo">
                        @csrf
                        @method("PUT")
                        <div class="mb-3">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    placeholder="inserte la descripcion de Requisito" type="text"  class="form-control @error('horaInicio')
                                        is-invalid
                                    @enderror" tabindex="2">
                                    @error('descripcion"')
                                    <span class="invalid-feedback" role="alert">
                        ...
                        <a href="{{route('requisitos.index')}}" class="btn btn-secondary btn-sm" tabindex="5">Cancelar</a>
