                   ...
                   <div class="col-md-6">
                    <form action="{{route ('area.store')}}" method="POST" id = "form-grupo">
                        ...
                        <div class="mb-3">
                            ...
                            <input id="cod_serv" placeholder="inserte codigo del area-CPS"
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input id="nombre" name="nombre" placeholder="inserte el nombre del area" type="text"  class="form-control @error('horaInicio')
                                        is-invalid
                                    @enderror" tabindex="2">
                                    @error('nombre')
                                    <span class="invalid-feedback" role="alert">
